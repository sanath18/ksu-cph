...
<form action="usercreatepointcheck.php" method="POST" enctype="multipart/form-data"><!--enctype is encoding type of choosen file-->
...
echo '<label class ="radio-inline">
    <input type="radio" name="optradio" value='.$recordset['LocationTypeId'].' aria-label="...">'.$recordset['LocationTypeName'].'
  </label>';
}
}
?>
