...
$s_loc=NULL;
	...
	$insert_query = "INSERT into `health_location` (Title,Latitude,Longitude,LocationType,url,Description,UserId,CreateDate,Approval,color,size,icon) VALUES ('$title', '$latitude', '$longitude','$optradio','$url','$description',$user_id,$time,5,'#000000','medium','n')";
