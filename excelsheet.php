...
include 'conn.php';
include_once 'users/Classes/PHPExcel.php';
include_once 'users/Classes/PHPExcel/Writer/IWriter.php';  
include_once 'users/Classes/PHPExcel/Writer/Excel5.php';  
include_once 'users/Classes/PHPExcel/IOFactory.php';  
