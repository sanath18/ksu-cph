...
$sql_loc = "SELECT * FROM health_location inner JOIN health_picture ON health_location.LocationId=health_picture.LocationId inner join health_locationtype on health_location.LocationType = health_locationtype.LocationTypeId where Approval=1;";
