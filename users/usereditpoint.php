...
<form action="usereditpointcheck.php" method="POST" enctype="multipart/form-data"><!--enctype is encoding type of choosen file-->
...
echo '<label class ="radio-inline">
    <input type="radio" name="Locationtype" value="'.$recordset['LocationTypeId'].'" aria-label="...">'.$recordset['LocationTypeName'].'
  </label>';
}
}
$conn->close();
...
$(document).ready(function(){
 $('input[value="'+locationtype+'"]').prop("checked",true);
})
</script>