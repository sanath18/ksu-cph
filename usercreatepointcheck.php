...
if(!empty($tmp_name)){
  ...
  $s_loc=NULL;
	...
	$insert_query = "INSERT into `health_location` (Title,Latitude,Longitude,LocationType,url,Description,UserId,Approval,color,size,icon) VALUES ('$title', '$latitude', '$longitude','$optradio','$url','$description',$user_id,3,'#0000ff','medium','u')";
